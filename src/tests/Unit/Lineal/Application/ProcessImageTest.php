...
namespace UnitTests\Lineal\Application;

use App\Lineal\Application\ProcessImage;
...
#[CoversClass(\App\Lineal\Application\ProcessImage::class)]
    ...
    public static function dataProviderForInvoke(): array
    {
        return [
            '5 x 5' => [
                ...
                self::getFixturePath('source_lineal_5x5.webp'),
                5,
                5,
            ],
            '10 x 10' => [
                self::getFixturePath('source.jpg'),
                self::getFixturePath('source_lineal_10x10.webp'),
                10,
                10,
            ],
            '20 x 20' => [
                self::getFixturePath('source.jpg'),
                self::getFixturePath('source_lineal_20x20.webp'),
                20,
                20,
            ],
        ];
